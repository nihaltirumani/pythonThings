...
class Slider:
    ...
    def draw(self, screen):
        ...
        pygame.draw.line(screen, "#4664fa", (self.x, (self.y + self.max_value * 3)), (self.x, self.y), 20)
        pygame.draw.rect(screen, "#3858fc", self.slider_button)

    def update(self):
         self.value = (((self.y - self.slider_button.y) - self.y))

    def get_value(self):
         return self.max_value - (((self.y - self.slider_button.y) - self.y))
