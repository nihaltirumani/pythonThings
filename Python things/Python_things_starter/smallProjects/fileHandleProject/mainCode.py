...
if command.lower() == "write":
    ...
    file = open("/Users/nihalTirumani/Desktop/pythonThings/Python things/Python_things_starter/smallProjects/fileHandleProject/Lastmessage.txt", "w")
    file.write(message)
    print("You have wriiten the message!")
    print("Rerun again to see is it working.")

elif command.lower() == "tell":
    file = open("/Users/nihalTirumani/Desktop/pythonThings/Python things/Python_things_starter/smallProjects/fileHandleProject/Lastmessage.txt", "r")
